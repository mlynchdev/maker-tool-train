...
function resolveHttpsConfig() {
  ...
  const keyPath = process.env.VITE_DEV_HTTPS_KEY_PATH ?? firstExisting([
  ...
  const certPath = process.env.VITE_DEV_HTTPS_CERT_PATH ?? firstExisting([
